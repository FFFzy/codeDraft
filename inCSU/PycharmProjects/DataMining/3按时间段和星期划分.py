...
numeric_variable = ['video_time','likes','coins','favorites','shares','views','comments','danmu']
...
if __name__ == '__main__':
    plot_line_bar(hour_group, 800, 100, 800000, 50000)
#
# 按星期
# data1['count']=1
...
#
# if __name__=='__main__':
#     plot_line_bar(weekday_group, 2000, 200, 850000, 50000)
